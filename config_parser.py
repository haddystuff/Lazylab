...
VOLUME_CONFIG_JINJA_TEMPLATE = sys.path[0] + "/xml_configs/" + "volume_config_jinja_template.xml"
NET_CONFIG_JINJA_TEMPLATE = sys.path[0] + "/xml_configs/" + 'net_config_jinja_template.xml'
